document.addEventListener('DOMContentLoaded', () => {
    ...
    if (terminalOutput) {
        const deploymentSteps = [
            { text: "> Initializing deployment process...", delay: 500, class: 'terminal-info', type: true },
            { text: "> Fetching latest commits from branch 'main'...", delay: 1500, class: 'terminal-info', type: true },
            { text: "> Resolving dependencies...", delay: 2800, class: 'terminal-info', type: true },
            { text: "[OK] Dependencies resolved.", delay: 3800, class: 'terminal-success', type: false },
            { text: "> Building application bundle...", delay: 4300, class: 'terminal-info', type: true },
            { text: "[OK] Build completed in 2.4s.", delay: 5500, class: 'terminal-success', type: false },
            { text: "> Running test suite (142 tests)...", delay: 6000, class: 'terminal-info', type: true },
            { text: "[OK] All tests passed.", delay: 7500, class: 'terminal-success', type: false },
            { text: "> Deploying to production server...", delay: 8000, class: 'terminal-info', type: true },
            { text: "----------------------------------------", delay: 9200, class: 'terminal-info', type: false },
            { text: "🚀 SUCCESS: 150+ proyectos desplegados con éxito.", delay: 9500, class: 'terminal-highlight', type: true, speed: 30 },
            { text: "----------------------------------------", delay: 11500, class: 'terminal-info', type: false },
            { text: "> System ready. Waiting for input...", delay: 12000, class: 'terminal-info', type: true }
        ];
